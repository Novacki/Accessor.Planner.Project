...
export class HttpService {
  ...
  private baseUrlAccessor = 'https://localhost:5001/api/';
  ...
  public post<T>(url: string, obj: T, options = {}): Observable<T> {
    return this.http.post<T>(`${this.baseUrlAccessor}${url}`, obj, options);
  }
